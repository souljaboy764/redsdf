...
from redsdf.data_loader import construct_loader_category
from redsdf.early_stopping_tools import EarlyStopping


def main():
    parser = argparse.ArgumentParser()
    parser.add_argument('--data_dir', type=str, default="./data_human", help="path of save generated data")
    ...
    parser.add_argument('--batch_size', type=int, default=2048, help="batch size to train")
    parser.add_argument('--center', type=str, default="0.0-0.0-0.0", help="center of object")
    ...
    train_loader, valid_loader, test_loader, poses = construct_loader_category(data_dir, batch_size=point_batch_size,
                                                                      pin_memory=True,
    ...
    redsdf = RegularizedDeepSignedDistanceFields(input_dim=3 + 256, # 3 for query point and 256 for pointnet++ embedding
